           ...
           <g:if test="${resourceVos}">
               <g:each in="${resourceVos as List<com.ttn.linksharing.vo.ResourceVO>}" var="vo">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <img src="http://vignette1.wikia.nocookie.net/logopedia/images/f/fb/Facebook_icon_2013.svg" height="10" width="10">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/f/f3/Twitter_icon.png" height="10px" width="10px">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/e/ed/Google_Plus_icon.svg" height="10px" width="10px">
                        </div>
